...
(function () {
    var TIPS = {
        'pt-PT': {
            ...
            drawTable: 'Permite desenhar as células da tabela à mão na página. Clique de novo ou Esc para sair. Inserir tabela continua no botão da tabela.',
            icon: 'Abre a grelha de ícones. Clique num ícone para o inserir. Anular (Ctrl+Z) remove-o.',
            capture: 'Captura uma zona do ecrã e cola-a no documento.',
            link: 'Cria ou edita uma hiperligação. Clique no texto ligado, depois Hiperligação. Ctrl+clique abre o site.',
            comment: 'Adiciona ou edita um comentário no texto selecionado. Duplo-clique para alterar. Resolver tira a marca e conserva o texto.',
            ...
            line: 'Insere uma linha horizontal. Clique na linha para a selecionar; o menu permite mudar o estilo ou Remover.',
            ...
            section: 'Começa uma nova secção na página seguinte (pode mudar margens a meio do documento).',
            ...
            pageBorder: 'Desenha um limite à volta de cada página.',
            ...
            xref: 'Insere uma referência a um título, figura ou tabela. Clique na referência para saltar.',
            citation: 'Insere uma citação no texto e atualiza a bibliografia. Duplo-clique na citação para editar. O estilo (APA/MLA/Chicago) altera também o texto.',
            bibliography: 'Gera a lista de fontes citadas.',
            index: 'Marca a palavra selecionada e lista-a com o número da página. Clique na entrada para saltar.',
            tof: 'Cria o índice de figuras.',
            citeStyle: 'Escolhe o estilo de citação (APA, MLA, Chicago). O estilo atual fica marcado. As citações e a bibliografia atualizam-se.',
            ...
            mdlPresetInsp: 'Aplica o relatório de inspeção de canalização / obra: capa, identificação, checklist de instalações, não conformidades, assinaturas e anexos.',
            ...
            mdlStyleInsp: 'Aplica o modelo completo de inspeção / obra (não só a cor da capa).',
